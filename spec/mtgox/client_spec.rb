...
describe MtGox::Client do
  ...
  describe "order methods" do
    ...
    describe "#orders" do
      it "should fetch both buys and sells, with only one call" do
        ...
        orders.buy.last.price.should == 14
        orders.sell.last.price.should == 29.3
      end
    end
  ...
  describe "#buy" do
    ...
    it "should place a bid" do
      ...
      a_post("/code/buyBTC.php").with(:body=> {"name"=>"my_name","pass"=>"my_password","amount"=>"0.88","price"=>"0.89"}).should have_been_made
    end
  end
  ...
  describe "sell" do
    ...
    it "should place an ask" do
      ...
      a_post("/code/sellBTC.php").with(:body=> {"name"=>"my_name","pass"=>"my_password","amount"=>"0.88","price"=>"89.0"}).should have_been_made
    end
  end
  ...
  describe "cancel" do
    ...
    it "should cancel an order" do
      buy = @client.buys.last
      @client.cancel(buy)
      a_post('/code/cancelOrder.php').with(:body=> {"name"=>"my_name","pass"=>"my_password","oid"=>"929308","type"=>"2"}).should have_been_made
    end
  end
